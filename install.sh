...
export GITHUB_SOURCE="v0.13.1"
export SCRIPT_RELEASE="v0.13.1"
export GITHUB_BASE_URL="https://raw.githubusercontent.com/Joao-Victor-Liporini/pterodactyl-installer-br/installer-us"
